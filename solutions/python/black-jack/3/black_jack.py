...
def value_of_ace(card_one, card_two):
    ...
    """
    def card_value_in_hand(card):
        if card == 'A':
            return 11
        return value_of_card(card)
    
    value_card_one = card_value_in_hand(card_one)
    value_card_two = card_value_in_hand(card_two)
...
def is_blackjack(card_one, card_two):
    ...
    return 'A' in hand_cards and bool(hand_cards & ten_cards)
